...
public class AlertasActivity extends AppCompatActivity {
    ...
    private void listAlertas(Cursor alertasCursor) {
        ...
        while (alertasCursor.moveToNext()) {
            ...
            if (alertasCursor.getString(alertasCursor.getColumnIndex("Tipo")).equals("R")) {
                row.setBackgroundColor(Color.RED);
            } else if (alertasCursor.getString(alertasCursor.getColumnIndex("Tipo")).equals("O")) {
                row.setBackgroundColor(Color.rgb(255, 165, 0));
            } else if (alertasCursor.getString(alertasCursor.getColumnIndex("Tipo")).equals("G")) {
